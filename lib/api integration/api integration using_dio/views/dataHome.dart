...
import 'package:project_june1/api%20integration/api%20integration%20using_dio/controller/datacontroller.dart';
import 'package:scrollable_positioned_list/scrollable_positioned_list.dart';
import 'package:top_snackbar_flutter/custom_snack_bar.dart';
import 'package:top_snackbar_flutter/top_snack_bar.dart';

import 'deatilData.dart';

void main(){
  runApp(GetMaterialApp(home: DataHome(),));
}
  ...
  Center loadAnimation() {
    return Center(
      child: SizedBox(
        width: 150,
        height: 150,
        child: Lottie.asset("assets/animation/animation_ln4c0hh7.json"),
      ),
    );
  }
        ...
        return InkWell(
          ...
          child:  Card(
            child: ListTile(
              ...
              title: Text(controller.datas[index].title!,style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            width: 100,
          height: 100,
          child: Lottie.asset("assets/animation/animation_ln4c1yat.json"),),
